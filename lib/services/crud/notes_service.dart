...
class NotesService {
  ...
  Future<DatabaseNote> uptadeNote({required DatabaseNote note, required String text}) async {
    await _ensureDbOpen();
    final db = _getDatabaseOrThrow();

    //male sure the note exists
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    //male sure that owner exists in the database
...
class DatabaseNote {
  ...
  @override
  String toString() => 'Note, ID = $id, userId = $userId, isSynced withCloud = $isSyncedWithCloud';
